...
<div class="container">
	<main id="tp_content" role="main">
		<div id="primary" class="content-area">
			...
			<?php
		        $elearning_education_sidebar_layout = get_theme_mod( 'elearning_education_sidebar_post_layout','right');
		        if($elearning_education_sidebar_layout == 'left'){ ?>
		        <div class="row m-0">
		        ...
		        <div class="clearfix"></div>
		    <?php }else if($elearning_education_sidebar_layout == 'right'){ ?>
		        <div class="row m-0">
		          	<div class="col-lg-8 col-md-8">
		    ...
		    <?php }else if($elearning_education_sidebar_layout == 'full'){ ?>
		        <div class="full">
		    ...
		    <?php }else if($elearning_education_sidebar_layout == 'three-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($elearning_education_sidebar_layout == 'four-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($elearning_education_sidebar_layout == 'grid'){ ?>
		        <div class="row m-0">

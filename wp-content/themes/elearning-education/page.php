	...
	<main id="tp_content" role="main">
		...
		<div class="container">
			<div id="primary" class="content-area">
				<?php $elearning_education_sidebar_layout = get_theme_mod( 'elearning_education_sidebar_page_layout','right');
			        ...
			        <div class="row">
			          	...
			          	<div class="col-md-8 col-sm-8 left-sidebar">
			           		<?php while ( have_posts() ) : the_post();
								...
								wp_link_pages( array(
									'before' => '<div class="page-links">' . __( 'Pages:', 'elearning-education' ),
									'after'  => '</div>',
								) );

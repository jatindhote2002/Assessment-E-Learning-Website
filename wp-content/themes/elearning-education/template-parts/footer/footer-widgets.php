...
<div class="container">
    <aside class="widget-area row py-2 pt-3" role="complementary" aria-label="<?php esc_attr_e( 'Footer', 'elearning-education' ); ?>">
        <div class="<?php echo esc_attr($elearning_education_col_lg_footer_class); ?> <?php echo esc_attr($elearning_education_col_md_footer_class); ?>">
            <?php dynamic_sidebar('footer-1'); ?>
        </div>
        <?php
        // Footer boxes 2 and onwards.
        for ($i = 2; $i <= $elearning_education_no_of_footer_col; $i++) :
            if ($i <= $elearning_education_no_of_footer_col) :
                ?>
               <div class="col-12 <?php echo esc_attr($elearning_education_col_lg_footer_class); ?> <?php echo esc_attr($elearning_education_col_md_footer_class); ?>">

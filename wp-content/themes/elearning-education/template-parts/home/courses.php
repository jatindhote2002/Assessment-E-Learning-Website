 ...
 */
?>
<?php if( get_theme_mod( 'elearning_education_online_courses_enable') != '') { ?>
    ...
    <?php if ( class_exists( 'LearnPress' ) ) {?>
      <div class="owl-carousel pt-5">
        <?php
          ...
          $loop = new WP_Query( $elearning_education_args );
          ...
          <div class="courses-box text-md-start text-center">
            ...
            <div class="courses-box-content p-2">
              ...
              <div class="courses-info">
                ...
                <span class="me-2"><i class="far fa-comment"></i> <?php echo esc_html(get_comments_number()); ?></span>
                <span class="me-2"><i class="far fa-user me-1"></i><?php echo esc_html($students); ?></span>
                <span><i class="far fa-clock me-1"></i><?php echo esc_html(learn_press_get_post_translated_duration( get_the_ID()), esc_html__( 'Lifetime access', 'elearning-education' ) ); ?></span>
              </div>
            </div>
          </div>

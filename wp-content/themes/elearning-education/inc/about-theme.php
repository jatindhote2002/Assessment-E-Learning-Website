...
function elearning_education_about_display() {
	...
	<div class="wrap about-wrap full-width-layout">
		...
		<nav class="nav-tab-wrapper wp-clearfix" aria-label="<?php esc_attr_e( 'Secondary menu', 'elearning-education' ); ?>">
			...
			<a href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'elearning-education-about', 'tab' => 'get_bundle' ), 'themes.php' ) ) ); ?>" class="blink wp-bundle nav-tab<?php echo ( isset( $_GET['tab'] ) && 'get_bundle' === $_GET['tab'] ) ?' nav-tab-active' : ''; ?>"><?php esc_html_e( 'Get WordPress Theme Bundle', 'elearning-education' ); ?></a>
		</nav>
...
function elearning_education_get_bundle() {
	...
	?>
		<div class="wrap about-wrap">
			...
			<p class="about-description"><?php esc_html_e( 'Get WordPress Theme Bundle', 'elearning-education' ); ?></p>
			<div class="col card">
				<h2 class="title"><?php esc_html_e( ' WordPress Theme Bundle of 65+ Themes At 15% Discount. ', 'elearning-education' ); ?></h2>
				<p><?php esc_html_e( 'Spring Offer Is To Get WP Bundle of 65+ Themes At 15% Discount use the coupon', 'elearning-education' ) ?>"<input type="text" value=" TPRIDE15 "  id="myInput">".</p>
				<p><a target="_blank" href="<?php echo esc_url( ELEARNING_EDUCATION_THEME_BUNDLE ); ?>" class="button button-primary"><?php esc_html_e( 'Theme Bundle', 'elearning-education' ); ?></a></p>
			</div>
		</div>
	<?php
	}
